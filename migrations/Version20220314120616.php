 ...
 */
final class Version20220314120616 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, assigned_to_id, task, due_date FROM task');
        ...
        $this->addSql('INSERT INTO task (id, assigned_to_id, task, due_date, is_finished) SELECT id, assigned_to_id, task, due_date, FALSE FROM __temp__task');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, assigned_to_id, task, due_date FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, assigned_to_id INTEGER DEFAULT NULL, task VARCHAR(255) NOT NULL, due_date DATE NOT NULL)');
        $this->addSql('INSERT INTO task (id, assigned_to_id, task, due_date) SELECT id, assigned_to_id, task, due_date FROM __temp__task');
        $this->addSql('DROP TABLE __temp__task');
        $this->addSql('CREATE INDEX IDX_527EDB25F4BD7827 ON task (assigned_to_id)');
    }
}
